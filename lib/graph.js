...
export const TENANT_ID = "f2ae1e4b-a9f1-4884-800b-9211c26ef289";
export const CLIENT_ID = "2f15a26a-9c06-42de-a0a0-81310c465712";
...
export const TOKEN_FILE = resolve(
  process.env.TEAMS_OUTLOOK_MCP_TOKENS ||
    resolve(process.env.LOCALAPPDATA ?? `${process.env.HOME}/AppData/Local`, "teams-outlook-mcp", "tokens.json")
);
